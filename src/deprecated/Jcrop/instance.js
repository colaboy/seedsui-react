    ...
    t.default = function (e, t, n, r) {
      ...
      function a(e) {
        ...
        ;(i = n.pageX),
          ...
          t(i, o, n) &&
            ('mousedown' === e.type
              ? (window.addEventListener('mousemove', u), document.addEventListener('mouseup', s))
              : 'touchstart' === e.type &&
      ...
      return (
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function () {
              return (
                !!this.enabled && (this.active ? this.active.el.focus() : this.el.focus(), this)
              )
            }
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                !!this.enabled &&
                !(null !== t.multiMax && e >= t.multiMax) &&
                !(!t.multi && e >= t.multiMin)
              )
            }
          },
          {
            ...
            value: function () {
              ...
              ;(0, u.default)(
                ...
                function (u, s, f) {
                  return (
                    !!a.canCreate() &&
                    ((e = (a.options.widgetConstructor || o.default).create(a.options)),
          ...
          },
          {
            ...
            value: function () {
              if (this.shades)
                return (
                  this.options.shade ? this.shades.enable() : this.shades.disable(),
                  this.options.shade && this.active && this.shades.adjust(this.active.pos),
                  this
                )
            }
          },
          {
            ...
            value: function () {
              ...
              ;(function e(t, n, r) {
                ...
                this.crops &&
                  Array.from(this.crops).forEach(function (t) {
        ...
        i(t, [
          ...
          },
          {
            ...
            value: function () {
              var e = this
              return (
                this.options.handles.forEach(function (t) {
                  var n,
                    r = a.default.create('jcrop-handle ' + t)
                  r.appendTo(e.el),
                    (0, s.default)(
                      r.el,
                      function () {
                        ...
                        var r = e.el.parentElement,
                          ...
                          o = r.offsetHeight
                        return (
                          (n = f.default.create(c.default.from(e.el), i, o, t)),
          ...
          },
          {
            ...
            value: function (e) {
              return (
                ...
                (this.el.style.height = Math.round(e.h) + 'px'),
                (this.pos = e),
  ...
  function (e, t, n) {
    ...
    var r = (e.exports = {
      ...
      inOutElastic: function (e, t, n, r) {
        ...
        return e < 1
          ? a * Math.pow(2, 10 * (e -= 1)) * Math.sin(((e * r - i) * (2 * Math.PI)) / o) * -0.5 + t
          : a * Math.pow(2, -10 * (e -= 1)) * Math.sin(((e * r - i) * (2 * Math.PI)) / o) * 0.5 +
              n +
              t
      },
      ...
      inOutBounce: function (e, t, n, i) {
        return e < i / 2
          ? 0.5 * r.inBounce(2 * e, 0, n, i) + t
          : 0.5 * r.outBounce(2 * e - i, 0, n, i) + 0.5 * n + t
      }
    })
  },
  function (e, t, n) {
            ...
            value: function () {
              ...
              ;(this.active = void 0 === t.shade || t.shade),
                ...
                this.el.addEventListener(
                  'crop.update',
                  function (t) {
                    t.cropTarget.isActive() &&
                      t.cropTarget.options.shade &&
                      e.adjust(t.cropTarget.pos)
                  },
                  !1
                ),
                this.enable()
