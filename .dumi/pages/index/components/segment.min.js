  ...
  (Segment.prototype = {
      ...
      if (((this.circular = n && n.hasOwnProperty('circular') ? n.circular : !1), t)) {
        ...
        !(function d() {
          ...
          return (
            ...
            n > 1 ? (s = 1) : (a.animationTimer = window.requestAnimationFrame(d)),
            (a.begin = o + (c - o) * s),
            (a.end = g + (u - g) * s),
    ...
    strokeDasharray: function (i, e) {
      if (((this.begin = this.valueOf(i)), (this.end = this.valueOf(e)), this.circular)) {
        var t =
          this.begin > this.end || (this.begin < 0 && this.begin < -1 * this.length)
            ? parseInt(this.begin / parseInt(this.length))
            : parseInt(this.end / parseInt(this.length))
        0 !== t &&
          ((this.begin = this.begin - this.length * t), (this.end = this.end - this.length * t))
      }
