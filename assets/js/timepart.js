...
(function(window,document,undefined){
	window.Timepart=function(container,params){
        ...
        s.getPartStartTime=function(){

        }
        s.getPartEndTime=function(startTimeStr){
            partStartTime.setTime(partStartTime.getTime()+partMilliSecond);
        }
        s.createParts=function(){
            ...
            var startTime=s.getDateByTimeStr(s.params.startTime);
            var endTime=s.getDateByTimeStr(s.params.endTime);
            //时间差
        ...
        s.getNumsByRange=function(startTime,endTime){//格式如08:00-22:00
            ...
            if(startTime instanceof Date){
                ...
                selStartTime=s.getDateByTimeStr(s.params.startTime);
            }
            ...
            if(endTime instanceof Date){
                ...
                selEndTime=s.getDateByTimeStr(s.params.endTime);
            }
